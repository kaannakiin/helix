...
const columns = useMemo(
  () => [
    ...
    createColumn<MyType>('loginCount', {
    ...
    createColumn<MyType>('_count.sessions', {
      headerKey: 'sessions',
      type: 'number',
    }),
  ],
