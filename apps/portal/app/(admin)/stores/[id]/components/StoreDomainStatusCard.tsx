...
export function StoreDomainStatusCard({
  ...
  const pendingDomainSpaces = useMemo(() => {
    ...
    return allDomainSpaces.filter((ds) => {
      ...
      return ds.ownership.status !== 'VERIFIED' || hasPendingBindingForStore;
    });
              ...
              <Group justify="space-between" align="center">
                <div>
                  <Group gap="xs" align="center">
                    <Clock size={14} color="var(--mantine-color-yellow-6)" />
                    <Text fw={600} size="sm">
                      {ds.baseDomain}
                    </Text>
                  </Group>
                  ...
                  <ActionIcon
                    ...
                    onClick={() =>
                      modals.openConfirmModal({
                        ...
                        children: (
                          <Text size="sm">{t('deleteDomainSpaceConfirm')}</Text>
                        ),
                        labels: {
                      ...
                      <ActionIcon
                        ...
                        onClick={() =>
                          modals.openConfirmModal({
                            ...
                            children: (
                              <Text size="sm">{t('deleteBindingConfirm')}</Text>
                            ),
                            labels: {
                            ...
                            confirmProps: { color: 'red' },
                            onConfirm: () => deleteBinding.mutate(binding.id),
                          })
                        }
                      >
                        <Trash2 size={14} />
